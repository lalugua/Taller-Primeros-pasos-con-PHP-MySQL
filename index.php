...
<head>
    ...
    <title>Laly Yiset Guayara Rada - Portafolio</title>
...
<body>
    <section id="home">
        <div class="contenido">
            ...
            <div class="presentacion">
                ...
                <h2>Soy <span>Laly Yiset Guayara Rada</span> Ingeniero de sistemas</h2>
    ...
    <section id="about">
        <div class="foto">
            <img src="public/image/laly.png" alt="foto de perfil">
        </div>
        <div class="info_sobreMi">
            <p class="titulo">Quien soy?</p>
            <h2>Soy, <span>Laly Yiset Guayara Rada</span></h2>
    ...
    <section id="contactus">
        ...
        <form action="">
            <div class="inputBox">
                <div class="input">
                    <span style="color: #fff;">NOMBRES Y APELLIDOS</span>
                    <input type="text" placeholder="Nombres y Apellidos">
                </div>
                <div class="input">
                    <span style="color: #fff;">NUMERO DE CONTACTO</span>
                    <input type="number" placeholder="(+57) 310 456 8796">
                </div>
            </div>
            <div class="inputBox">
                <div class="input">
                    <span style="color: #fff;">ASUNTO DEL MENSAJE</span>
                    <input type="text" placeholder="Solicitud, Queja, Reclamos, Felicitaciones">
                </div>
            </div>
            <div class="inputBox">
                <div class="input">
                    <span style="color: #fff;">COMENTARIOS</span>
        ...
        <div class="contact-container">
            ...
            <div class="contact-card">
                ...
                <h3 class="contact-card-title">Correo</h3>
                <span class="contact-card-data">lalugua23@gmail.com</span>
            </div>

            <div class="contact-card">
                <i class='bx bxl-whatsapp contact-card-icon'></i>
                <h3 class="contact-card-title">Whatsapp</h3>
                <span class="contact-card-data">(+57) 313 8973629</span>
            </div>
